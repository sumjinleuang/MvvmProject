...
public class ArrowItemView extends ConstraintLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        boolean showPhoto = a.getBoolean(R.styleable.ArrowItemView_arrowItemShowPhoto, false);
        ivPhoto.setVisibility(showPhoto ? VISIBLE : GONE);


        int photoSrcResourceId = a.getResourceId(R.styleable.ArrowItemView_arrowItemPhotoSrc, -1);
        if(photoSrcResourceId != -1) {
            ivPhoto.setImageResource(photoSrcResourceId);
        }
